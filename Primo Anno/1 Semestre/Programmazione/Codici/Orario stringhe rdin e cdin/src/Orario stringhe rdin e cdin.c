...
struct Orario AllocaMemoria(struct Orario Orario1, int Colonne1,int Righe1){
	Orario1.Tabella = malloc(Colonne1*sizeof(struct Lezione));
	int pos=0;
...
int main(void) {
	...
	Orario1= AllocaMemoria(Orario1,Colonne,Righe);
